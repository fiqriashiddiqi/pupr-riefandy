...
require.config({
 baseUrl: crnProtocol + "sanders-fintech/assets/Sanders/scripts",
 paths: {
...
require(["jquery", "migrate", "bootstrap", "tabcollapse", "twbspagination"], function($) {
 ...
 (function() {
  ...
  var baseUrl = window.location.origin + '/',
   thispage = JQBCA('section.container, section.container-fluid').attr('class').split(" ")[1],
   ...
   var responsive = function() {
    ...
    if (mobilemode) {
     try {
      ...
      JQBCA('body > .container, body > .container-fluid, footer, .showcase').removeAttr('style');
