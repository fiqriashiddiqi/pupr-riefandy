            ...
            var init = function () {
				...
				if (JQBCA('#content-ebranch').length > 0) {
                    JQBCA("#ddlProvinces").change(function () {
                        ...
                        try {
                            var parameterModel = { Province: Provinsi };
