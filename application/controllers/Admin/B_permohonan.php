...
class B_permohonan extends CI_Controller {
	...
	public function index()
	{
		...
		$data['brd_title_main'] = "Daftar Permohonan";
		$data['brd_title_url'] = site_url('Admin/B_permohonan');
		...
		$this->load->view('backend-web/root/permohonan-teknis', $data);
