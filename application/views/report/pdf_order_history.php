...
<script type="text/php">
  ...
  <table style="width: 99%;margin-top: 3%" class="list">
    <tr class="head">
      <td style="vertical-align: middle;padding-left: 5px;">
        <h1 style="text-align: left">Order History Report</h1>
      </td>
  ...
  <table class="list" style="width: 99%; margin-top: 1em;">
    ...
    <tr class="head">
      <td class="center" style="width: 15%">Order</td>
      <td class="center" style="width: 15%">Date</td>
      <td class="center" style="width: 15%">Amount<br>(+)</td>
      <td class="center" style="width: 15%">Rating</td>
      <td class="center" style="width: 15%;">Rates</td>
      <td class="center" style="width: 15%">Purpose</td>
      <td class="center" style="width: 15%">Status</td>
    </tr>
    <?php
      // $beginning = 0;
      // $pokok = 0;
    ...
    <tr class="list_row" style="background-color: whitesmoke; ">
      <td class="center"><?php echo $loan_entry->id_borrower_loan; ?></td>
      <td class="center"><?php echo date('d-m-Y',strtotime($loan_entry->loan_date)); ?></td>
      <td class="center">Rp. <?php echo number_format($loan_entry->loan_amount,0,".","."); ?></td>
      <td class="center"><?php echo $loan_entry->loan_rating; ?></td>
      <td class="center"><?php echo $loan_entry->loan_rate; ?></td>
      <td class="center"><?php echo $loan_entry->loan_type; ?></td>
      <td class="center"><?php echo $loan_entry->loan_status ;?></td>
    </tr>
    <?php 
    }
    ?>
