...
<script type="text/php">
  ...
  <table style="width: 99%;margin-top: 3%" class="list">
    <tr class="head" style="border-bottom: 1px solid black;border-top: 1px solid black;">
      <td class="center" style="vertical-align: middle;padding-left: 5px;">
        <h1 style="text-align: left;">Cashflow Report</h1>
      </td>

      <td class="center" style="text-align: right;padding-right: 5px;">
      <h1 style="text-align: right"><?php echo $bio_fullname[0]->bio_fullname;?></h1>
      <span style="font-weight: bold; font-size: 1em;"><?php echo date('F Y');?></span>
      </td>
    </tr>
  ...
  <table class="list" style="width: 99%; margin-top: 1em;">
    ...
    <tr class="head">
      <td class="center" style="width: 15%">Date</td>
      <td class="center" style="width: 15%">Beginning</td>
      <td class="center" style="width: 15%">Pokok<br>(+)</td>
      <td class="center" style="width: 15%">Interest<br>(+)</td>
      <td class="center" style="width: 15%;">Tax<br>(-)</td>
      <td class="center" style="width: 15%">Invest<br>(-)</td>
      <td class="center" style="width: 15%">Withdrawal<br>(-)</td>
      <td class="center" style="width: 15%">Deposit<br>(-)</td>
      <td class="center" style="width: 15%">Ending</td>
      <td class="center" style="width: 15%;">Note</td>
    </tr>
    <?php
      // $beginning = 0;
      // $pokok = 0;
      ...
      $i = 0;
        foreach ($data_cashflow as $cashflow_entry) {
          ...
          $data_report[$i]=$entry;
          $i++;
          // var_dump($data_report[$i]=$entry);
          // die();
    ?>
    <tr class="list_row" style="background-color: whitesmoke; ">
      <td class="center"><?php echo  date('d-m-Y',strtotime($cashflow_entry->cashflow_date)); ?></td>
      <td class="center"><?php echo number_format($cashflow_entry->beginning_amount,0,".","."); ?></td>
      <td class="center"><?php echo number_format($cashflow_entry->payment_pokok,0,".","."); ?></td>
      <td class="center"><?php echo number_format($cashflow_entry->payment_tax,0,".","."); ?></td>
      <td class="center"><?php echo number_format($cashflow_entry->payment_interest,0,".","."); ?></td>
      <td class="center"><?php echo number_format($cashflow_entry->invest_amount,0,".","."); ?></td>
      <td class="center"><?php echo number_format($cashflow_entry->withdrawal_amount,0,".","."); ?></td>
      <td class="center"><?php echo number_format($cashflow_entry->deposit_amount,0,".","."); ?></td>
      <td class="center"><?php echo number_format($cashflow_entry->total_amount,0,".","."); ?></td>
      <td class="center"><?php echo $cashflow_entry->cashflow_status ;?></td>
    </tr>
    <?php 
    }
    ?>
    <!-- <tr class="foot">
      ...
      <td class="center"><?php echo number_format($tot_beginning,0,".","."); ?></td>
      <td class="center"><?php echo number_format($tot_pokok,0,".","."); ?></td>
      <td class="center"><?php echo number_format($tot_tax,0,".","."); ?></td>
      <td class="center"><?php echo number_format($tot_interest,0,".","."); ?></td>
      <td class="center"><?php echo number_format($tot_invest,0,".","."); ?></td>
      <td class="center"><?php echo number_format($tot_withdrawal,0,".","."); ?></td>
      <td class="center"><?php echo number_format($tot_deposit,0,".","."); ?></td>
      <td class="center"><?php echo number_format($tot_ending,0,".","."); ?></td>
      <td class="center"></td>
