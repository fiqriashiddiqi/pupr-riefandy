...
header("Content-Disposition: attachment; filename=Laporan_BPHTB.xls");
?>
<html>
<body>
    <?php
                            ...
                            <table width="1000" border="1">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $total = 0;
                                        $total_all = 0;
                                        $data_laporan = $this->report_bphtb_model->get_laporan_list_report_admin(null,@$id_backend_users,@$start_date,@$end_date);
                                    ...
                                    <tr>
                                          ...
                                          <td><?php echo chr(39). $laporan_entry->nop; ?></td>
                                          <td><?php echo $laporan_entry->nama_wajib_pajak; ?></td>
                                        ...
                                        echo "
                                          <tr>
                                            <td colspan='9'><b>Total Seluruh</b></td>
