          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>1.</td>
                  <td>Rekomendasi Teknis Perpanjangan Waktu</td>
                  <td>
                    <center>
                      <a href="<?php echo base_url();?>uploads/file/7. Persetujuan Add V Bangga.pdf" download><i class="icon fa fa-download "></i></a>
                    </center>
                  </td>
                  <!-- <td>
                    <center>
