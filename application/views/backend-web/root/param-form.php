        ...
        <div class="box" id="">
            ...
            <form action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group">
                  <label for="param_name">Nama Parameter</label>
                  <input type="text" class="form-control" id="param_name" name="param_name" maxlength="100" placeholder="Nama Parameter" required="true">
                 <!--  <span style="color: #dd4b39;">* isi nama pengguna.</span> -->
              </div>
              
              <div class="form-group">
                  <label for="param_value">Value</label>
                  <input type="text" class="form-control" id="param_value" name="param_value" placeholder="Value" required="true">
