...
<!-- Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      TANGGAPAN NOTA DINAS DARI DIREKTORAT SUNGAI DAN PANTAI
        <small></small>
      </h1>
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>1.</td>
                  <td>Tanggapan Nota Dinas dari Direktorat Sungai dan Pantai</td>
                  <td>
                    <center>
                      <a href="<?php echo base_url();?>uploads/file/6. Image_225.pdf" download><i class="icon fa fa-download "></i></a>
                    </center>
                  </td>
                  <!-- <td>
                    <center>
