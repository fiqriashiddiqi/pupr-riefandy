        ...
        <div class="box" id="">
            ...
            <form action="<?php echo $form_url; ?>" method="post" enctype="multipart/form-data">
             ...
             <!--  <div class="form-group">
                  <label for="kd_tempat">Kode Tempat</label>
                  <input type="text" class="form-control" id="kd_tempat" name="kd_tempat" minlength="4" maxlength="100" placeholder="Kode Tempat" required="true"> -->
                 <!--  <span style="color: #dd4b39;">* isi nama pengguna.</span> -->
              <!-- </div> -->
              
              <div class="form-group">
                  <label for="nama_tempat">Nama Tempat</label>
                  <input type="text" class="form-control" id="nama_tempat" minlength="8" maxlength="30" name="nama_tempat" placeholder="NamaTempat" required="true">
