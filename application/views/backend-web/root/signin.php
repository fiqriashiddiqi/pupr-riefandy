...
DIREKTORAT SUNGAI DAN PANTAI</p>
        ...
        <div class="row">
          <div class="input-field col s12">
            ...
            <label for="username" data-error="Minimal 4 karakter">Username</label>
          </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
        ...
        <div class="row" style="margin-left:10%">
          ...
          <div class="input-field col">
            <a href="<?php echo site_url('auth/forgot_password') ?>" class="btn btn-primary" style="background-color: #0000ff;">Sign Up</a>
