          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <table id="" class="table table-bordered table-striped">
                ...
                <tr>
                  <td>1.</td>
                  <td>Nota Dinas Permohonan Tanggapan Rekomendasi Teknis</td>
                  <td>
                    <center>
                      <a href="<?php echo base_url();?>uploads/file/9. 20220411_ND Permohonan Tanggapan atas Usulan Adendum Kontrak Paneki pada Kegiatan JICA IP-580.pdf" download><i class="icon fa fa-download "></i></a>
                    </center>
                  </td>
                  <!-- <td>
                    <center>
