...
DIREKTORAT SUNGAI DAN PANTAI</p>
        ...
        <div class="row">
          <div class="input-field col s12">
            ...
            <input id="username" name="no_kontrak" type="number" class="validate" minlength="4" required="true">
            <label for="username" data-error="Minimal 4 karakter">Nomer Kontrak</label>
          </div>
        </div>
